    ...
    return (
        ...
        <div className="p-5 border-b  border-black sm:border-b-0 sm:border-r  sm:border-black md:text-2xl">
            ...
            <div className="flex flex-row justify-center items-center">
                ...
                <button className="border border-black p-1 m-1 text-[14px] md:text-[28px] w-1/4 h-6 flex justify-center items-center hover:bg-white hover:text-gray-600">Sign Up</button>
            </div>
